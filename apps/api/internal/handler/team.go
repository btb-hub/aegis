...
func (h *TeamHandler) updateTeam(c *gin.Context) {
	...
	if body.ExpressChatID != nil || body.SlackChannelID != nil || body.SlackUserGroupID != nil {
		team, err = h.teams.UpdateTeamChannels(c.Request.Context(), id, body.ExpressChatID, body.SlackChannelID, body.SlackUserGroupID)
		if err != nil {
			WriteError(c, err)
			return
		}
